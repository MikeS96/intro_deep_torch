...
Expressing this mathematically as shown by Fig. \ref{fig:f25} the output \(y_{ij}\) is one if a specific class is obtained from the door \(j\). Therefore, the equation for \textbf{multi-class entropy} is given by Eq. \eqref{eq:9} where n is the number of classes.
