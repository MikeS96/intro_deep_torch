...
It is possible to represent logic operators as AND or OR with simple perceptrons, nevertheless, a problem araises when the problem has non-linear boundaries
